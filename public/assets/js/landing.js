...
// ─── Background Anime Cards (Jikan API - Low Res Optimized) ────
async function loadBackgroundAnimeCards() {
  const fallbackImages = [
    "https://cdn.myanimelist.net/images/anime/1015/138006v.jpg", // Frieren
    "https://cdn.myanimelist.net/images/anime/1208/94745t.jpg",  // Attack on Titan
    "https://cdn.myanimelist.net/images/anime/1286/99889t.jpg",  // Demon Slayer
    "https://cdn.myanimelist.net/images/anime/1935/127974t.jpg", // Chainsaw Man
    "https://cdn.myanimelist.net/images/anime/1171/109222t.jpg", // Jujutsu Kaisen
    "https://cdn.myanimelist.net/images/anime/1141/142503t.jpg", // Solo Leveling
    "https://cdn.myanimelist.net/images/anime/1908/135007t.jpg", // Oshi no Ko
    "https://cdn.myanimelist.net/images/anime/10/47347t.jpg",    // Hunter x Hunter
    "https://cdn.myanimelist.net/images/anime/5/73723t.jpg",     // Monster
    "https://cdn.myanimelist.net/images/anime/13/17405t.jpg",    // Naruto Shippuden
    "https://cdn.myanimelist.net/images/anime/6/73245t.jpg",     // Steins;Gate
    "https://cdn.myanimelist.net/images/anime/3/40409t.jpg",     // Gintama
    "https://cdn.myanimelist.net/images/anime/1337/93786t.jpg",   // One Piece
    "https://cdn.myanimelist.net/images/anime/1223/96541t.jpg",   // Fullmetal Alchemist Brotherhood
    "https://cdn.myanimelist.net/images/anime/11/39717t.jpg"     // Death Note
  ];
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (data && data.data) {
        imageUrls = data.data
          .map(item => item.images?.webp?.small_image_url || item.images?.jpg?.small_image_url || item.images?.jpg?.image_url)
          .filter(Boolean);
      }
    }
  } catch (e) {
